...
if __name__ == "__main__":
    ...
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='YOLO11 Segmentation Training Script')
    parser.add_argument('--data', type=str, default="coco8-seg.yaml", help='数据集配置文件路径')
    parser.add_argument('--epochs', type=int, default=500, help='训练轮数')
    parser.add_argument('--imgsz', type=int, default=1920, help='训练图像尺寸')
    ...
    parser.add_argument('--project', type=str, default="runs/seg", help='项目保存路径')
